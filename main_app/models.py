...
class Nutrition_Label(models.Model):
    ...
    total_fat_unit = models.CharField(default = 'g')
    saturated_fat = models.FloatField(default = 0.0)
    saturated_fat_unit = models.CharField(default = 'g')
    trans_fat = models.FloatField(default = 0.0)
    trans_fat_unit = models.CharField(default = 'g')
    cholesterol = models.FloatField(default = 0.0)
    cholesterol_unit = models.CharField(default= 'mg')
    sodium = models.FloatField(default = 0.0)
    sodium_unit = models.CharField(default = 'mg')
    dietary_fiber = models.FloatField(default = 0.0)
    dietary_fiber_unit = models.CharField(default = 'g')
    protein = models.FloatField(default = 0.0)
    protein_unit = models.CharField(default = 'g')
    total_carbs = models.FloatField(default = 0.0)
    total_carbs_unit = models.CharField(default = 'g')
    total_sugars = models.FloatField(default = 0.0)
    total_sugars_unit = models.CharField(default = 'g')
